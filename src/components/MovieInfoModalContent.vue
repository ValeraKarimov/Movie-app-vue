    ...
    <div class="movie-info-content">
      <BRow>
        ...
        <BCol sm="8">
          ...
          <div class="mt-3 mb-4">
            <BBadge variant="success" class="mr-2 movie-descr">{{ movie.Year }}</BBadge>
            <BBadge variant="success" class="mr-2 movie-descr">{{ movie.Runtime }}</BBadge>
            <BBadge variant="success" class="mr-2 movie-descr">{{ movie.Genre }}</BBadge>
            <BBadge variant="success" class="mr-2 movie-descr">{{ movie.Language }}</BBadge>
          </div>
